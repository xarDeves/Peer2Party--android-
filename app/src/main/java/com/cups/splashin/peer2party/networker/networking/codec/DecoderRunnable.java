...
public class DecoderRunnable implements Runnable {
    ...
    private final Object swingWorkerLock;

    private String saveDirectory = "c:/users/epics/desktop"; // change later to dynamic
    SimpleDateFormat dateFormat;

    public DecoderRunnable(Object decoderLock, Object swingWorkerLock){
    ...
    private void decode(){
        ...
        while(ioData.hasElementsInboundData()){
            ...
            synchronized (swingWorkerLock){
                swingWorkerLock.notify();
            }
